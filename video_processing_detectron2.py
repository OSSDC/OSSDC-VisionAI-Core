...
def init_model(transform):
    ...
    # cfg.merge_from_file(model_zoo.get_config_file("COCO-InstanceSegmentation/densepose_rcnn_R_50_FPN_s1x.yaml"))
...
def process_image(transform,processing_model,img):
    ...
    try:
        ...
        if count>0:
            ...
            #This line is not needed on Google Colab
            img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB) 

            # img1: np.ndarray = out.get_image()[:, :, ::-1]
            # img  = img1.copy()
